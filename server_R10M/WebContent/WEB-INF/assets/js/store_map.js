...
var oPoint = new nhn.api.map.LatLng(37.578734, 126.985299);//지도중심점 좌표
    ...
    //좌표등록
    var oPoint1 = new nhn.api.map.LatLng(37.579613,126.977062);//경복궁
    ...
    //경복궁 마커
    var oMarker1 = new nhn.api.map.Marker(oIcon, { title : '경복궁' });  //마커 생성
    ...
    //창덕궁 마커
    var oMarker2 = new nhn.api.map.Marker(oIcon, { title : '창덕궁' });  //마커 생성
    ...
    //종묘 마커
    var oMarker3 = new nhn.api.map.Marker(oIcon, { title : '종묘' });  //마커 생성
