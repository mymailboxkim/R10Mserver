	  ...
	  <!-- 이미지 슬라이드 메인 하단 배너형식 이벤트 부분 -->  
	    ...
	    <div id="contentImage" class="content">
	  		<div class="animation_canvas">
		   	...
		   	<h3>Store</h3><a href="/gogoong/store.do"><h5>more></h5></a>
		   	
	    	    <table>
		          <tr>
		            <td class="contxt" style="height:60px;"><a href="/gogoong/store.do"><img id="image2" alt="" src="../../assets/img/go_icon.png"/></a></td>
		          	<td  style="height:60px;"><a href="/gogoong/app/store.do">&nbsp;&nbsp;Gyeongbokgung<br>&nbsp;&nbsp; Guide Application </a></td>
		          </tr>
		          <tr>
		            <td class="contxt"><a href="/gogoong/app/store.do"><img id="image2" alt="" src="../../assets/img/go_icon_2.png"/></a></td>
		          	<td><a href="/gogoong/app/store.do">&nbsp;&nbsp;Changdeokgung<br>&nbsp;&nbsp; Guide Application </a></td>
		          </tr>
		   	    </table>        
	   		</div>
		</div>
