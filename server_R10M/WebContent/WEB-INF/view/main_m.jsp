	    	    ...
	    	    <table>
		          <tr>
		            <td class="contxt" style="height:60px;"><a href="/gogoong/store.do"><img id="image2" alt="" src="../assets/img/go_icon.png"/></a></td>
		          	<td  style="height:60px;"><a href="/gogoong/store.do">&nbsp;&nbsp;Gyeongbokgung<br>&nbsp;&nbsp; Guide Application </a></td>
		          </tr>
		          <tr>
		            <td class="contxt"><a href="/gogoong/store.do"><img id="image2" alt="" src="../assets/img/go_icon_2.png"/></a></td>
		          	<td><a href="/gogoong/store.do">&nbsp;&nbsp;Changdeokgung<br>&nbsp;&nbsp; Guide Application </a></td>
		          </tr>
		   	    </table>        
	   		</div>
		</div>
